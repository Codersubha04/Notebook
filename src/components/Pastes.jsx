...
import { Calendar, Copy, Eye, PencilLine, Trash2, Link } from "lucide-react";
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-y-4 sm:items-end">
                                        <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                                            ...
                                            <button className="p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-purple-500">
                                            ...
                                            >
                                                <Link
                                                    className="text-black group-hover:text-orange-500" // Change color on hover
                                                    size={20}
                                                />
                                            </button>
                                        </div>
